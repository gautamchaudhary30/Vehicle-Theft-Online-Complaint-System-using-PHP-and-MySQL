...
?>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="register-complaint.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Vehicle Theft Complaint</span></a>
					</li>
					<li class="nav-item">
